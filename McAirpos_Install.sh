...
# 1. Make sure to start in directory /home/ark
if [[ ! -d /home/ark ]]; then
   C_USER=$USER
   sudo mkdir -p /home/ark
   sudo chmod 755 /home/ark
   sudo chown $C_USER:$C_USER /home/ark
   C_USER=
fi
cd /home/ark
if [[ $(pwd) = "/home/ark" ]]; then
...
if [[ -d ./McAirpos ]]; then
   ...
   if [[ ! $SUCCESS = 1 ]] && [[ -f /bin/tar ]]; then
      ...
      if [[ $SUCCESS = 1 ]]; then
         ...
         tar -xf ./master.tar -C /home/ark
         mv /home/ark/McAirpos-master /home/ark/McAirpos
         rm -f ./master.tar
      fi
   fi
   if [[ ! $SUCCESS = 1 ]]; then
...
sudo chown -R ark /sd&&sudo chgrp -R ark /sd&&sudo chmod -R 755 /sd
...
if [[ -f /etc/emulationstation/es_systems.cfg ]]; then
   ...
   sudo sed -i '$e cat /home/ark/McAirpos/McAirpos/EmulationStation/es_systems.cfg_MakeCode' /etc/emulationstation/es_systems.cfg
...
#   sudo chown -R pi ~/RetroPie/roms/makecode&&sudo chgrp -R pi ~/RetroPie/roms/makecode&&sudo chmod -R 755 ~/RetroPie/roms/makecode
   sudo chown -R ark /roms2/makecode&&sudo chgrp -R ark /roms2/makecode&&sudo chmod -R 755 /roms2/makecode
fi
